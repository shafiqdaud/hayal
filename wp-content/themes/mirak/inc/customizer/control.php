...
class Mirak_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="mirak-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Mirak_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Mirak_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Mirak_Note_Control extends WP_Customize_Control {
