...
( function( $, api ) {
    ...
    api.controlConstructor['mirak-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['mirak-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#mirak-img-container li label img').click(function(){       
    //     $('#mirak-img-container li').each(function(){
    //         $(this).find('img').removeClass ('mirak-radio-img-selected') ;
    //     });
    //     $(this).addClass ('mirak-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', mirak_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', mirak_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', mirak_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #mirak-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #mirak-img-container li').each(function(){
            $(this).find('img').removeClass ('mirak-radio-img-selected') ;
        });
        $(this).addClass ('mirak-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #mirak-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #mirak-img-container li').each(function(){
            $(this).find('img').removeClass ('mirak-radio-img-selected') ;
        });
        $(this).addClass ('mirak-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #mirak-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #mirak-img-container li').each(function(){
            $(this).find('img').removeClass ('mirak-radio-img-selected') ;
        });
        $(this).addClass ('mirak-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #mirak-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #mirak-img-container li').each(function(){
            $(this).find('img').removeClass ('mirak-radio-img-selected') ;
        });
        $(this).addClass ('mirak-radio-img-selected') ;
    });    

    function mirak_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            mirak_customize_multi_write( $control );
    }

    function mirak_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        mirak_customize_multi_write( $control );
    }

    function mirak_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function mirak_customize_multi_write( $element) {
