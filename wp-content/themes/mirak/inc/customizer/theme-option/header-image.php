...
$wp_customize->add_section( 
    ...
    array(
        ...
        'title'       => esc_html__( 'Header Image For Inner Pages', 'mirak' ),
...
$wp_customize->add_setting( 'theme_options[archive_header_image]',
    array(
        ...
        'sanitize_callback' => 'mirak_sanitize_image',
    )
);
...
$wp_customize->add_control( 
    new WP_Customize_Image_Control( $wp_customize, 'theme_options[archive_header_image]',
        array(
            'label'         => esc_html__( 'Header Image For Archive Page', 'mirak' ),
            'description'   => esc_html__( 'Choose Header Image of your choice for Archive Pages. Recommended size for this image is 1920px by 500px.', 'mirak' ),
